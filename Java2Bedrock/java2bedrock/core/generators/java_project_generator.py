...
from core.generators.resources.blockstate_generator import (
    BlockstateGenerator
)
...
class JavaProjectGenerator:
    ...
    def generate(self):
        ...
        blockstate_generator = BlockstateGenerator(
            self.block_translations,
            str(self.output_path)
        )

        blockstate_generator.generate()

        print(
            "Generated blockstates:",
            blockstate_generator.count()
        )
